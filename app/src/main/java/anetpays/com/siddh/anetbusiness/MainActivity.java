package anetpays.com.siddh.anetbusiness;
...
import anetpays.com.siddh.anetbusiness.Constants.SharedPreferencesConstants;
import anetpays.com.siddh.anetbusiness.Extras.CrossfadeWrapper;
import anetpays.com.siddh.anetbusiness.Extras.CustomPinActivity;
import anetpays.com.siddh.anetbusiness.UI.AboutApp;
import anetpays.com.siddh.anetbusiness.UI.AcceptPayment;
import anetpays.com.siddh.anetbusiness.UI.UserHelp;
import anetpays.com.siddh.anetbusiness.UI.UserProfile;
import anetpays.com.siddh.anetbusiness.UI.UserSettings;
import anetpays.com.siddh.anetbusiness.UI.UserTransactions;

import static anetpays.com.siddh.anetbusiness.Constants.SharedPreferencesConstants.PREF_FIRST_RUN;
import static anetpays.com.siddh.anetbusiness.Constants.SharedPreferencesConstants.PREF_LOGIN;
import static anetpays.com.siddh.anetbusiness.Constants.SharedPreferencesConstants.PREF_MISC;
        ...
        if (requestCode == 100) {
            RuntimePermissionUtil.onRequestPermissionsResult(grantResults, new RPResultListener() {
                ...
                public void onPermissionGranted() {
                    if (RuntimePermissionUtil.checkPermissonGranted(MainActivity.this, cameraPermission)) {
                        SharedPreferences.Editor editor = getSharedPreferences(PREF_MISC, MODE_PRIVATE).edit();
                        editor.putBoolean(SharedPreferencesConstants.hasCameraPer, true);
                        editor.apply();
                    }
                }
